...
var login = function (p) {
  if (p.name != "") {
    var neu =
      player_list.value.find(function (player) {
    ...
    var old = sessions.value.find(function (s) {
...
module.exports = function (io) {
  var pushHTML = function (s) {
    ...
    if (s == null) {
      if (QuestionnaireIndex.value == -1) {
        ...
        var v =
          (_b =
            (_a = game.value[QuestionnaireIndex.value]) === null ||
            _a === void 0
              ? void 0
  ...
  return function (socket) {
    ...
    var session_name =
      (_b =
        (_a = socket.handshake.auth) === null || _a === void 0
          ? void 0
    ...
    console.log(
      "Socket ".concat(socket.id, " has connected ").concat(session_name)
    );
